...
class ContentCreatorCrew(BaseCrew):
    def __init__(self):
        ...
        def retrieve_node(state: ContentCreatorState) -> Dict[str, Any]:
        ...
        def analyse_node(state: ContentCreatorState) -> Dict[str, Any]:
            analysis = self.analyse(state["retrieved_chunks"])
            return {"analysis": analysis}

        def generate_artifacts_node(state: ContentCreatorState) -> Dict[str, Any]:
